		...
		.done(function(data) {
			...
			$.each(data, function(index, val) 
			{
				...
				if (val["movimiento"] != null) {
					...
					action_refacciones	+="<button type='button' class='btn btn-sm btn-primary bak_order' style='min-width: 140px; max-width: 140px; min-height: 50px; max-height: 50px; background: #152f6d;'  id='bak_order-"+val["id"]+"'data-folio='"+val.movID.MovID+"'><i class='fas fa-list-ol'></i>&nbsp&nbsp Ver Back Order</button>";
