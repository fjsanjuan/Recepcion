...
$(document).on("click", '#btn_guardarFirma', function (e){
    ...
    {
        toastr.info("La firma para el Formato profeco está vacía, favor de proporcionarla.");
    }
    else if( validar_ext_garantia && ($("#valor_firma3").val() == firma_vacia  && input_ext_garantia == 'no' ) ){
            toastr.info("La firma para la Carta de renuncia a la extensión de garantía está vacía, favor de proporcionarla.",{timeOut: 7000});
    }
    else 
    {
        $.ajax({
