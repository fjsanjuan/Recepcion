	...
	public function enviar_presupuesto_mail()
	{
		...
		$mail = $this->phpmailerlib->load();
			try {
			    ...
			    $mail->Host = 'mail.gfarrera.mx';// Specify main and backup SMTP servers
	...
	public function enviar_orden_mail()
	{
        ...
        //if($formato)
        {
			try {
			    ...
			    $mail->AddReplyTo("notificacionesautotec@gfarrera.mx",'Service Excellence');  //A quien debe ir dirigida la respuesta
			    //$mail->addCC($correo_asesor);						  			  			//Con copia a
			    //$mail->addBCC('fsanjuan@intelisis.com');						  			//Con copia oculta a
