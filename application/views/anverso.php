...
@media print {
   ...
   <?php if($total_anversos < $total_manos): ?>
	...
	<?php else: ?>
		<body class="gray-bg" style="overflow-x: auto;" cz-shortcut-listen="true">
			<div class="container bg-warning text-center"><h1>No puedes abrir más anversos ya que abriste <?php echo $total_anversos; ?> anversos y tienes <?php echo $total_manos; ?> manos de obra en la orden.</h1></div>
		</body>
	<?php endif; ?>
	<?php
	echo form_close();
