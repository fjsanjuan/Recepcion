							...
							<tbody>
								<?php
									...
									foreach ($detalle as $key => $value) {
										...
										echo "<td style='text-align: center;'><input type='checkbox' class='chk_aut2' style='height: 24px; width: 24px;' id='".$value['id_presupuesto']."-".$value['cve_articulo']."' value='".$value['cve_articulo']."' name='check_aut2[]' ".($value['en_existencia'] == 1? 'checked' : '')." ".($perfil == 6? '': 'disabled')."><label for='".$value['id_presupuesto']."-".$value['cve_articulo']."'></label></td></tr>";
