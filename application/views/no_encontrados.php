    ...
    <!-- <div class="row" > 
        <div class="col-md-6" style="margin: 0 auto;">
            <div class="card card-body border border-warning">
                <h4 style="text-align: center;" class="card-title"><i class="fa fa-warning" aria-hidden="true"></i> Sin resultados <i class="fa fa-warning" aria-hidden="true"></i></h4>
                <p class="card-text">No se han encontrado resultados para tu búsqueda</p>
                <div class="flex-row">
                    <ul>
                        <li><a class="card-link hvr-underline-from-left" href="<?= $_SERVER['HTTP_REFERER']; ?>">realizar otra búsqueda?</a></li>
                        <li><a class="card-link hvr-underline-from-left ">dar de alta?</a></li>
                    </ul>
